        ...
        <>
            <div className='convert'>
                <div className='convert-row1'>
                    <h3>Binance OTC </h3>
                    <Link to='/covertHist' style={{textDecoration: 'none'}}><button>OTC Trading Hoistory <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="css-hfx4ru"><path fill-rule="evenodd" clip-rule="evenodd" d="M21 11.999l-7.071-7.071-1.768 1.768 4.055 4.054H2.999v2.5h13.216l-4.054 4.053 1.768 1.768L21 12v-.001z" fill="currentColor"></path></svg></button></Link>
                </div>
                <div className='convert-row2'>
                    ...
                    <button className='convert-row2-btn'><Link to='/convert' style={{textDecoration: 'none', color: 'white'}}>Request for Quote</Link></button>
                </div>
